...
const ruleIdentifier = '@sketch2react/sketch2react-core-assistant/group-name-css-classnames'

const groupNameCssClassnames: RuleDefinition = {
  rule: async (context) => {
    const { utils } = context
...
export default groupNameCssClassnames
